...
import resume from "../../images/resMasterDJ.pdf";
import "./About.css";
    ...
    <div className="container">
      <div className="row">
        <div className="col-12 col-lg-7 pl-lg-0 pr-lg-5">
          ...
          <h5 className="text-white mb-5" style={styles.main}>
          Within 3 months of graduating my bootcamp, I was fortunate enough to get a Jr. Frontend Developer job at a company called InvestCloud, where after only 5 months of employment, they asked me to become a mentor for other developers in the company! Overall I spent 2 and a half years there, and am now ready for the next step in my development career!
          </h5>
          <h5 className="text-white mb-5" style={styles.main}>
          Please enjoy looking through my portfolio of projects I've worked on!
          </h5>
        </div>
